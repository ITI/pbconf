 ...
 * @author Joe
 */
public class IndividualMustHaveProperty implements ClosedWorld.Validator {
    static final Logger logger = Logger.getLogger(IndividualMustHaveProperty.class.getName().replaceFirst(".+\\.", ""));
    ...
    public String getExplanation() {
        ...
        fullExplanation += IndividualMustHaveProperty.class.getName().replaceFirst(".+\\.", "");
    ...
    public boolean saveLastRequest(String nextCWR) {
        ...
        try {
            ...
            IRI classTargetIRI = IRI.create(cwPrefix + "#" + "hasIndividualTarget");
            IRI requiresPropertyIRI = IRI.create(cwPrefix + "#" + "requiresProperty");

            ind.setProperty(reasonerNameIRI, "IndividualMustHaveProperty");
