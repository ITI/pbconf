 ...
 * @author anderson
 */
public class ClassMustNotHaveProperty implements ClosedWorld.Validator {
    static final Logger logger = Logger.getLogger(ClassMustNotHaveProperty.class.getName().replaceFirst(".+\\.", ""));
    ...
    public String getExplanation() {
        ...
        fullExplanation += ClassMustNotHaveProperty.class.getName().replaceFirst(".+\\.", "");
    ...
    public boolean saveLastRequest(String nextCWR) {
        ...
        try {
            ...
            ind.setProperty(reasonerNameIRI, "ClassMustNotHaveProperty");
